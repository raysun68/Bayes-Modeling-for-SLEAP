...
1. Focused on tracking the mid-center to provide a basis for Bayesian inference and time series analysis.
...
Plans for next week:
1. Try to refine parameters of my function to get the best performance, clean up the code and upload to github.
